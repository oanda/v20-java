...
public class MarketOrderRejectTransaction implements Transaction {
    ...
    public MarketOrderRejectTransaction set_id(String __id) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_time(String __time) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_userID(int __userID) {
    ...
    */
    ...
    public MarketOrderRejectTransaction set_accountID(String __accountID) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_batchID(String __batchID) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_requestID(String __requestID) { 
    ...
    */
    ...
    @SerializedName("type") private TransactionType _type = TransactionType.MARKET_ORDER_REJECT;
    /**
    ...
    */
    ...
    public MarketOrderRejectTransaction set_instrument(String __instrument) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_units(double __units) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_timeInForce(TimeInForce __timeInForce) { 
    ...
    */
    ...
    // Numeric stored as String
    public MarketOrderRejectTransaction set_priceBound(double __priceBound) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_positionFill(OrderPositionFill __positionFill) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_tradeClose(MarketOrderTradeClose __tradeClose) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_longPositionCloseout(MarketOrderPositionCloseout __longPositionCloseout) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_shortPositionCloseout(MarketOrderPositionCloseout __shortPositionCloseout) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_marginCloseout(MarketOrderMarginCloseout __marginCloseout) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_delayedTradeClose(MarketOrderDelayedTradeClose __delayedTradeClose) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_reason(MarketOrderReason __reason) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_clientExtensions(ClientExtensions __clientExtensions) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_takeProfitOnFill(TakeProfitDetails __takeProfitOnFill) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_stopLossOnFill(StopLossDetails __stopLossOnFill) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_trailingStopLossOnFill(TrailingStopLossDetails __trailingStopLossOnFill) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_tradeClientExtensions(ClientExtensions __tradeClientExtensions) { 
    ...
    */
    ...
    public MarketOrderRejectTransaction set_rejectReason(TransactionRejectReason __rejectReason) { 
