...
public class TransferFundsTransaction implements Transaction {
    ...
    public TransferFundsTransaction set_id(String __id) { 
    ...
    */
    ...
    public TransferFundsTransaction set_time(String __time) { 
    ...
    */
    ...
    public TransferFundsTransaction set_userID(int __userID) {
    ...
    */
    ...
    public TransferFundsTransaction set_accountID(String __accountID) { 
    ...
    */
    ...
    public TransferFundsTransaction set_batchID(String __batchID) { 
    ...
    */
    ...
    public TransferFundsTransaction set_requestID(String __requestID) { 
    ...
    */
    ...
    @SerializedName("type") private TransactionType _type = TransactionType.TRANSFER_FUNDS;
    /**
    ...
    */
    ...
    public TransferFundsTransaction set_amount(double __amount) { 
    ...
    */
    ...
    public TransferFundsTransaction set_fundingReason(FundingReason __fundingReason) { 
    ...
    */
    ...
    // Numeric stored as String
    public TransferFundsTransaction set_accountBalance(double __accountBalance) { 
