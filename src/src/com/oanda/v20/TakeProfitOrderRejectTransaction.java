...
public class TakeProfitOrderRejectTransaction implements Transaction {
    ...
    public TakeProfitOrderRejectTransaction set_id(String __id) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_time(String __time) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_userID(int __userID) {
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_accountID(String __accountID) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_batchID(String __batchID) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_requestID(String __requestID) { 
    ...
    */
    ...
    @SerializedName("type") private TransactionType _type = TransactionType.TAKE_PROFIT_ORDER_REJECT;
    /**
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_tradeID(String __tradeID) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_clientTradeID(String __clientTradeID) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_price(double __price) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_timeInForce(TimeInForce __timeInForce) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_gtdTime(String __gtdTime) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_triggerCondition(OrderTriggerCondition __triggerCondition) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_reason(TakeProfitOrderReason __reason) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_clientExtensions(ClientExtensions __clientExtensions) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_orderFillTransactionID(String __orderFillTransactionID) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_intendedReplacesOrderID(String __intendedReplacesOrderID) { 
    ...
    */
    ...
    public TakeProfitOrderRejectTransaction set_rejectReason(TransactionRejectReason __rejectReason) { 
