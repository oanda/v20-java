...
public class CloseTransaction implements Transaction {
    ...
    public CloseTransaction set_id(String __id) { 
    ...
    */
    ...
    public CloseTransaction set_time(String __time) { 
    ...
    */
    ...
    public CloseTransaction set_userID(int __userID) {
    ...
    */
    ...
    public CloseTransaction set_accountID(String __accountID) { 
    ...
    */
    ...
    public CloseTransaction set_batchID(String __batchID) { 
    ...
    */
    ...
    public CloseTransaction set_requestID(String __requestID) { 
    ...
    */
    ...
    @SerializedName("type") private TransactionType _type = TransactionType.CLOSE;
    /**
