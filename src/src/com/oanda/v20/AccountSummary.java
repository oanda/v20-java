...
public class AccountSummary {
    ...
    public AccountSummary set_id(String __id) { 
    ...
    */
    ...
    public AccountSummary set_alias(String __alias) {
        this._alias = __alias;
        return this;
    }
    /**
    ...
    */
    ...
    public AccountSummary set_currency(String __currency) { 
    ...
    */
    ...
    public AccountSummary set_balance(double __balance) { 
    ...
    */
    ...
    public AccountSummary set_createdByUserID(int __createdByUserID) {
    ...
    */
    ...
    public AccountSummary set_createdTime(String __createdTime) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_pl(double __pl) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_resettablePL(double __resettablePL) { 
    ...
    */
    ...
    public AccountSummary set_resettabledPLTime(String __resettabledPLTime) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_marginRate(double __marginRate) { 
    ...
    */
    ...
    public AccountSummary set_marginCallEnterTime(String __marginCallEnterTime) { 
    ...
    */
    ...
    public AccountSummary set_marginCallExtensionCount(int __marginCallExtensionCount) {
    ...
    */
    ...
    public AccountSummary set_lastMarginCallExtensionTime(String __lastMarginCallExtensionTime) { 
    ...
    */
    ...
    public AccountSummary set_openTradeCount(int __openTradeCount) {
    ...
    */
    ...
    public AccountSummary set_openPositionCount(int __openPositionCount) {
    ...
    */
    ...
    public AccountSummary set_pendingOrderCount(int __pendingOrderCount) {
    ...
    */
    ...
    public AccountSummary set_hedgingEnabled(boolean __hedgingEnabled) {
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_unrealizedPL(double __unrealizedPL) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_NAV(double __NAV) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_marginUsed(double __marginUsed) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_marginAvailable(double __marginAvailable) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_positionValue(double __positionValue) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_marginCloseoutUnrealizedPL(double __marginCloseoutUnrealizedPL) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_marginCloseoutNAV(double __marginCloseoutNAV) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_marginCloseoutMarginUsed(double __marginCloseoutMarginUsed) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_marginCloseoutPercent(double __marginCloseoutPercent) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_marginCloseoutPositionValue(double __marginCloseoutPositionValue) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_withdrawalLimit(double __withdrawalLimit) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_marginCallMarginUsed(double __marginCallMarginUsed) { 
    ...
    */
    ...
    // Numeric stored as String
    public AccountSummary set_marginCallPercent(double __marginCallPercent) { 
    ...
    */
    ...
    public AccountSummary set_lastTransactionID(String __lastTransactionID) { 
