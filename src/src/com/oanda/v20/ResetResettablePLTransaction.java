...
public class ResetResettablePLTransaction implements Transaction {
    ...
    public ResetResettablePLTransaction set_id(String __id) { 
    ...
    */
    ...
    public ResetResettablePLTransaction set_time(String __time) { 
    ...
    */
    ...
    public ResetResettablePLTransaction set_userID(int __userID) {
    ...
    */
    ...
    public ResetResettablePLTransaction set_accountID(String __accountID) { 
    ...
    */
    ...
    public ResetResettablePLTransaction set_batchID(String __batchID) { 
    ...
    */
    ...
    public ResetResettablePLTransaction set_requestID(String __requestID) { 
    ...
    */
    ...
    @SerializedName("type") private TransactionType _type = TransactionType.RESET_RESETTABLE_PL;
    /**
