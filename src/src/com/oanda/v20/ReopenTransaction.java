...
public class ReopenTransaction implements Transaction {
    ...
    public ReopenTransaction set_id(String __id) { 
    ...
    */
    ...
    public ReopenTransaction set_time(String __time) { 
    ...
    */
    ...
    public ReopenTransaction set_userID(int __userID) {
    ...
    */
    ...
    public ReopenTransaction set_accountID(String __accountID) { 
    ...
    */
    ...
    public ReopenTransaction set_batchID(String __batchID) { 
    ...
    */
    ...
    public ReopenTransaction set_requestID(String __requestID) { 
    ...
    */
    ...
    @SerializedName("type") private TransactionType _type = TransactionType.REOPEN;
    /**
